...
#define ANKI_VERSION_MINOR 1
#define ANKI_VERSION_MAJOR 0
#define ANKI_REVISION 1083
...
#define ANKI_WINDOW_BACKEND ANKI_WINDOW_BACKEND_SDL
#define ANKI_WINDOW_BACKEND_STR "ANKI_WINDOW_BACKEND_SDL"

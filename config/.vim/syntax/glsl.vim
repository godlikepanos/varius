...
syn keyword        glslType                int   ivec2 ivec3 ivec4 uint uvec2 uvec3 uvec4
syn keyword        glslType                float vec2  vec3  vec4
syn keyword        glslType                mat2  mat3  mat4
syn keyword        glslType                sampler1D sampler2D sampler3D samplerCube sampler1DShadow sampler2DShadow usampler2D isampler2D sampler2DArray sampler2DArrayShadow
syn keyword        glslType                lowp mediump highp precision

syn keyword        glslStructure           struct

syn keyword        glslStorageClass        const attribute varying uniform layout flat smooth location buffer
syn keyword        glslStorageClass        in out inout

syn keyword        glslConstant            __LINE__ __FILE__ __VERSION__ GL_ES
...
syn keyword        glslState               gl_Position gl_PointSize gl_ClipVertex gl_InstanceID
...
syn keyword        glslFunc                abs sign floor ceil fract mod min max clamp mix step smoothstep round
syn keyword        glslFunc                packUnorm4x8 unpackUnorm4x8 packHalf2x16 unpackHalf2x16 floatBitsToUint uintBitsToFloat
...
syn keyword        glslFunc                texture2D texture2DProj texture2DLod texture2DProjLod texture textureProj textureLod textureOffset
...
syn keyword        glslFunc                textureSize texture textureLod textureOffset

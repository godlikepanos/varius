...
class MyView extends GLSurfaceView
{
	...
	private void init(boolean translucent, int depth, int stencil)
	{
		...
		/*
		 * By default, GLSurfaceView() creates a RGB_565 opaque surface. If we want
		 * a translucent one, we should change the surface's format here, using
		 * PixelFormat.TRANSLUCENT for GL Surfaces is interpreted as any 32-bit
		 * surface with alpha by SurfaceFlinger.
		 */
		if (translucent)
		{
	...
	private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser
	{
		...
		private void printConfig(EGL10 egl, EGLDisplay display, EGLConfig config)
		{
			int[] attributes = { EGL10.EGL_BUFFER_SIZE, EGL10.EGL_ALPHA_SIZE, EGL10.EGL_BLUE_SIZE, EGL10.EGL_GREEN_SIZE,
					...
					EGL10.EGL_MAX_PBUFFER_WIDTH, EGL10.EGL_NATIVE_RENDERABLE,
